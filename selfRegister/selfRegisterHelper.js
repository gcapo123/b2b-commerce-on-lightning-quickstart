({
    ...
    handleSelfRegister: function (component, event, helpler) {
        ...
        var vatcode = component.find("vatcode").get("v.value");
        ...
        action.setParams({country:country, firstname:firstname,lastname:lastname,email:email, companyname:companyname, vatcode:vatcode, phone:phone,
