({
    ...
    splitAllocation : function(component, event, helper) {
        ...
        {
            allocationNew.Id=null;
            if(allocationOringinal.months[i].percentage%10!=0)
            {
                //if not a multiple of 10, +5 in the new allocation, because the step is of 5
                var percentage = allocationOringinal.months[i].percentage;
                allocationOringinal.months[i].percentage = (percentage-5)/2;
                allocationNew.months[i].percentage = ((percentage-5)/2)+5;
            }
            else
            {
