({
    ...
    handleServerResponse : function(component, helper, responseVal){
        ...
        if((date.getMonth()+1)>=Number($A.get("$Label.c.PMT_FiscalYearStartMonth"))){
    ...
    getMonthsForProject : function(component, helper){
        ...
        var fiscalStartMonth = Number($A.get("$Label.c.PMT_FiscalYearStartMonth"))-1;
        ...
        for(var i=0;i<=difference;i++)
        {
            ...
            year.months = helper.getMonths(startMonth, endMonth);
            years.push(year);
        }
        return years;
    },
    getMonths : function(startMonth, endMonth){
